    ...
    <div class="pt-36">
        <x-section>
            ...
            <div class="flex justify-center">
                <p class="py-10 text-3xl text-gray20 w-2/3 text-center">A kúriában 3 darab, 35-45 nm közötti, két
                    légteres lakosztály található, melyekhez 3-5 nm-es zuhanyzós fürdőszoba tartozik. A hálószobában
                    kétszemélyes franciaágy, míg a nappaliban kihúzható kanapé van elhelyezve, mely maximum két, 14 éven
                    aluli személy számára vehető igénybe. A teraszon kerti garnitúra található.
                    A feltüntetett árak az idegenforgalmi és áruforgalmi adót tartalmazzák. Az ár az étkezéseket nem
                ...
                <div class="w-full md:w-2/3">
                    ...
                    <div class="py-20 grid grid-cols-2 md:grid-cols-4 gap-10">
                        <div class=" flex items-center justify-start ">
                            <img class="w-10 mr-5" src="/images/svg/bathroom.svg" alt="Fürdõszoba"
                                title="Fürdõszoba">
                        ...
                        <div class=" flex items-center justify-start ">
                            <img class="w-10 mr-5" src="/images/svg/hair-dryer.svg" alt="Hajszárító"
                                title="Hajszárító">
                        ...
                        <div class=" flex items-center justify-start">
                            <img class="w-10 mr-5" src="/images/svg/television.svg" alt="4k Smart TV"
                                title="4k Smart TV">
                            <p class="text-2xl lg:text-3xl text-gray20">4k Smart TV</p>
                        </div>
                        <div class=" flex items-center justify-start ">
                            <img class="w-10 mr-5 text-gold99" src="/images/svg/electric-kettle.svg" alt="Vízforraló"
                                title="Vízforraló">
                            <p class="text-2xl lg:text-3xl text-gray20">Vízforraló</p>
                        </div>
                        <div class=" flex items-center justify-start ">
                            <img class="w-10 mr-5 text-gold99" src="/images/svg/coffee-cup.svg" alt="Kapszulás kávéfőző"
                                title="Kapszulás kávéfőző">
                            <p class="text-2xl lg:text-3xl text-gray20">Kapszulás kávéfőző</p>
                        </div>
                        <div class=" flex items-center justify-start ">
                            <img class="w-10 mr-5 text-gold99" src="/images/svg/toaster.svg" alt="Pirítós sütő"
                                title="Pirítós sütő">
                            <p class="text-2xl lg:text-3xl text-gray20">Pirítós sütő</p>
                        </div>
                        <div class=" flex items-center justify-start ">
                            <img class="w-10 mr-5 text-gold99" src="/images/svg/fridge.svg" alt="Hűtőszekrény"
                                title="Hűtőszekrény">
                            <p class="text-2xl lg:text-3xl text-gray20">Hűtőszekrény</p>
                        </div>
                        <div class=" flex items-center justify-start ">
                            <img class="w-10 mr-5 text-gold99" src="/images/svg/restaurant.svg"
                                alt="Tányérok, evőeszközök" title="Tányérok, evőeszközök">
                            <p class="text-2xl lg:text-3xl text-gray20">Tányérok, evőeszközök</p>
                        </div>
                        <div class=" flex items-center justify-start ">
                            <img class="w-10 mr-5 text-gold99" src="/images/svg/wine-glass.svg" alt="Poharak"
                                title="Poharak">
