                        ...
                        <div class="carousel-item absolute opacity-0">
                            <div class="shadow-lg">
                                <picture class="relative">
                                    ...
                                    <img class="w-full" src="/images/{{ $suite['name'] }}.png" alt="{{ $suite['alt'] }}"
                                        title="{{ $suite['title'] }}" height="640" width="860">
                                </picture>
                            </div>
                        </div>
                        <label for="carousel-{{ $suite['label'] }}"
            ...
            <div class="flex items-center justify-center">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 w-2/3 text-gold99 text-3xl md:text-4xl uppercase">
                    ...
                    <div class="flex flex-col items-center justify-around  space-y-5">
                        ...
                        <p class="lg:text-5xl normal-case align-middle">65.000 Ft</p>
                    </div>
                </div>
            </div>
