...
@section('meta_data')
    <meta name="description"
        content="{{ __('A kúriában 6 darab, 22 nm-es két ágyas szoba található, melyekhez 3 nm-es zuhanyzós fürdőszoba tartozik. A feltüntetett árak az idegenforgalmi és áruforgalmi adót tartalmazzák. Az ár az étkezéseket nem tartalmazza.') }}">
    ...
    <div class="pt-36">
        <x-section>
            ...
            <div class="flex justify-center">
                <p class="py-10 text-3xl text-gray20 w-2/3 text-center">A kúriában 6 darab, 22 nm-es két ágyas szoba
                    található, melyekhez 3 nm-es zuhanyzós fürdőszoba tartozik. A feltüntetett árak az idegenforgalmi és
                    áruforgalmi adót tartalmazzák. Az ár az étkezéseket nem tartalmazza.</p>
            </div>
                        ...
                        <div class="carousel-item absolute opacity-0">
                            <div class="shadow-lg">
                                <picture class="relative">
                                    ...
                                    <img class="w-full" src="/images/{{ $room['name'] }}.png" alt="{{ $room['alt'] }}"
                                        title="{{ $room['title'] }}" height="640" width="860">
                                </picture>
                            </div>
                        </div>
            ...
            <div class="flex items-center justify-center">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 w-2/3 text-gold99 text-3xl md:text-4xl uppercase">
                    ...
                    <div class="flex flex-col items-center justify-around  space-y-5">
                        ...
                        <p class="lg:text-5xl normal-case align-middle">45.000 Ft</p>
                    </div>
                </div>
            </div>
