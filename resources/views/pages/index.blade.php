...
@section('meta_data')
    <meta name="description"
        content="{{ __('A part menti dombokra épült, erdők és hegyek ölelésében található Balatonszepezden várjuk múltszázadi hangulatú kúriánkba, pihenni vágyó vendégeinket. Az 1850-es években épült kúria, a falu központjában,a vízpart közelében,a templomkert szomszédságában korhű állapotában pompázik.') }}">
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center space-x-4 md:space-x-8 my-9">
                                            <div class="flex items-center">
                                                <img class="mr-2" height="30" width="30"
                                                    src="/images/svg/users.svg" alt="">
                                                <p class="text-3xl lg:text-3xl text-gray20">{{ $room['description'] }}
                                                </p>
                                            </div>
                                            <div class="flex items-center">
                                                <img class="mr-2" height="30" width="30"
                                                    src="/images/svg/cash.svg" alt="">
            ...
            <div class=" py-20">
                <div class="flex flex-col lg:flex-row items-center justify-center">
                    ...
                    <div
                        ...
                        <p class="text-3xl text-gray20 text-center">Reggeli egyénileg rendelhető hazai termelői
                            finomságokból. Rókáné kosara termelői reggeli és piknik kosár kiszállítva, egyéni
                            rendeléssel és fizetéssel!</p>
                        <x-button><a href="https://rokanekosara.hu/
">Menü</a></x-button>
                    </div>
            ...
            <div class="flex flex-col md:flex-row my-20 mx-10 shadow-lg">
                <div class="w-full lg:w-1/2 flex justify-center">
                    <picture class="relative">
                        ...
                        <img class="w-full h-full" height="600" width="700" src="/images/cartoon.png"
                            alt="cartoon">
                    </picture>
                </div>
                <div
                    ...
                    <div class="flex items-center justify-center w-full">
                        <img class="w-10" height="35" width="35" src="/images/svg/coffee.svg"
                            alt="">
                ...
                <div class="flex flex-col md:justify-center w-full md:w-1/2">
                    <div class="pt-20 grid grid-cols-2 gap-4 md:gap-4">
                        ...
                        <picture class="relative">
                            ...
                            <img class="h-full" height="200" width="420" src="/images/old2.png"
                                alt="cartoon">
                        </picture>
                        <picture class="relative">
                            <source srcset ="/images/old3.webp" type="image/webp">
                            <img class="h-full" height="200" width="420" src="/images/old3.png"
                                alt="cartoon">
                        </picture>
                        <picture class="relative">
                            <source srcset ="/images/old4.webp" type="image/webp">
                            <img class="h-full" height="200" width="420" src="/images/old4.png"
                                alt="cartoon">
                        </picture>
                    </div>
                </div>
