           ...
           <div class="carousel-item">
            <div class="shadow-lg">
                <picture class="relative">
                    ...
                    <img class="w-full" :src="`/images/${slide.image.name}.png`" alt="room" title="room" height="640" width="860">
                </picture>
                <div class="p-9 lg:h-80 flex flex-col items-center lg:absolute z-20 inset-x-0 bottom-0 bg-white bg-opacity-75">
                    ...
                    <a :href="slide.href" class="border hover:border-transparent border-gold99 text-gold99 hover:text-white hover:bg-gold99 bg-opacity-75  transition-colors ease-in duration-500 font-medium items-center pt-3.5 px-8 xl:px-10 pb-2.5 text-2xl lg:text-3xl uppercase shadow-sm focus:outline-none">
        ...
        <template x-for="slide in slides" :key="slide.id">
          <button
            ...
            :class="{ 
                ...
                'bg-red-300': activeSlide !== slide.id 
            }" 
