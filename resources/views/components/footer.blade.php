<div class="bg-gray20 bg-opacity-80">
    <div class="container mx-auto pt-10 md:py-20">
        <div class="grid grid-cols-1 md:grid-cols-5 space-y-5 md:space-y-0 mb-10    ">
            ...
            <div class="space-y-5 flex flex-col items-center md:items-start"> 
                ...
                <a href="/szoba" class="text-white text-xl lg:text-2xl">Szobák</a>
                <a href="/lakosztaly" class="text-white text-xl lg:text-2xl">Lakosztály</a>
            </div>
            <div class="space-y-5 flex flex-col items-center md:items-start">
                <h2 class="text-whitef8 text-2xl lg:text-3xl uppercase font-semibold">Információk</h2>
                <a href="/etkezes" class="text-white text-xl lg:text-2xl">Étkezés</a>
                <a href="/szolgaltatsok" class="text-white text-xl lg:text-2xl">Szolgáltatások</a>
                <a href="/palyazat" class="text-white text-xl lg:text-2xl">Pályázat</a>
            </div>
            <div class="space-y-5 flex flex-col items-center md:items-start">
                <h2 class="text-whitef8 text-2xl lg:text-3xl uppercase font-semibold">Kapcsolat</h2>
                <a href="/rolunk" class="text-white text-xl lg:text-2xl">Rólunk</a>
                <a href="/lapcsolat" class="text-white text-xl lg:text-2xl">Kapcsolat</a>
            </div>
        </div>
    </div>
    <div class="border-t border-white mt-5 md:mt-0 py-5 lg:py-10 flex items-center justify-center">
        <p class="text-white text-xl lg:text-2xl">Copyright © 2021</p>
    </div>
</div>